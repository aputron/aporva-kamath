...
export default function Page() {
  return (
    <section>
      <h1 className="max-w-[36rem] mb-8 text-4xl tracking-tighter lowercase">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <a
          ...
          className="lowercase text-black block bg-white rounded-lg shadow-md p-6 border border-gray-200 hover:shadow-lg transition-shadow duration-200"
